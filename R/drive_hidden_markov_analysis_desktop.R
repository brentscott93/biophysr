...
hmm_dribble <- drive_mkdir(name = "model",
                           path = results_dribble,
                           overwrite = TRUE)
...
#' The algorithm for event detection is a Variance-Hidden-Markov-Model. The model only receives the running variance as input.
...
#' This provides insight into how the model decided what an event or baseline is.
